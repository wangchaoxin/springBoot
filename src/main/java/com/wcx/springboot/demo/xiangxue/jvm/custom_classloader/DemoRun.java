package com.wcx.springboot.demo.xiangxue.jvm.custom_classloader;
...
public class DemoRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class<?> clazz = 
        		demoCustomClassLoader.findClass("com.wcx.springboot.demo.xiangxue.jvm.custom_classloader.DemoUser");
